...
export default function Home() {
  ...
  async function improveHook(hook: string, id: string) {
    setImproving(id);
    setError("");
    ...
    try {
      ...
      if (!res.ok) {
        throw new Error(data.error || "Could not improve hook");
      }
      ...
      {hooks && (
        <div ref={resultsRef}>
          ...
          >
            ...
            >
              {totalGenerated} hooks generated for{" "}
              <strong>{niche}</strong>
            </div>
          ...
          >
            ...
            >
              <span>
                {
                  CATEGORY_CONFIG[
                    activeTab as keyof typeof CATEGORY_CONFIG
                  ]?.emoji
                }
              </span>
